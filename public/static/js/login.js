...
$(function () {
    ...
    var account_regular=/^[0-9a-zA-Z]{6,12}$/
                    ...
                    success:function (data) {
                        ...
                        switch(data.code) {
                            case 201:
                                ...
                                window.location.href=ul('index','index','index')
                                break;
                            case 202:
                                localStorage.setItem(account.val(),data.photo);
                                window.location.href=ul('admin','index','index')
                                break;
                            case 203:
                                localStorage.setItem(account.val(),data.photo);
                                window.location.href=ul('boss','index','index')
                                break;
                            case 105:
